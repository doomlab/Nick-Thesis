---
title             : "We need a reall title here, something with a colon"
shorttitle        : "Title"
...
m5 = mean(dat$TSS.1)
m6 = mean(dat$QCON.1)
m7 = mean(dat$LogHAL.1)
m8 = mean(dat$LogSub.1)
m9 = mean(dat$Length.1)
m10 = mean(dat$Ortho.1)
m11 = mean(dat$Phono.1)
m12 = mean(dat$Phonemes.1)
m13 = mean(dat$Syllables.1)
m14 = mean(dat$Morphemes.1)
m15 = mean(dat$AOA.1)
m16 = mean(dat$Valence.1)
m17 = mean(dat$Imageability.1)
m18 = mean(dat$Familiarity.1)
...
sd10 = sd(dat$Ortho.1)
sd11 = sd(dat$Phono.1)
sd12 = sd(dat$Phonemes.1)
sd13 = sd(dat$Syllables.1)
sd14 = sd(dat$Morphemes.1)
sd15 = sd(dat$AOA.1)
sd16 = sd(dat$Valence.1)
sd17 = sd(dat$Imageability.1)
sd18 = sd(dat$Familiarity.1)
...
min5 = min(dat$TSS.1)
min6 = min(dat$QCON.1)
min7 = min(dat$LogHAL.1)
min8 = min(dat$LogSub.1)
min9 = min(dat$Length.1)
min10 = min(dat$Ortho.1)
min11 = min(dat$Phono.1)
min12 = min(dat$Phonemes.1)
min13 = min(dat$Syllables.1)
min14 = min(dat$Morphemes.1)
min15 = min(dat$AOA.1)
min16 = min(dat$Valence.1)
min17 = min(dat$Imageability.1)
min18 = min(dat$Familiarity.1)
...
max5 = max(dat$TSS.1)
max6 = max(dat$QCON.1)
max7 = max(dat$LogHAL.1)
max8 = max(dat$LogSub.1)
max9 = max(dat$Length.1)
max10 = max(dat$Ortho.1)
max11 = max(dat$Phono.1)
max12 = max(dat$Phonemes.1)
max13 = max(dat$Syllables.1)
max14 = max(dat$Morphemes.1)
max15 = max(dat$AOA.1)
max16 = max(dat$Valence.1)
max17 = max(dat$Imageability.1)
max18 = max(dat$Familiarity.1)
...
m20 = mean(dat$TSS.2)
m21 = mean(dat$QCON.2)
m22= mean(dat$LogHAL.2)
m23 = mean(dat$LogSub.2)
m24 = mean(dat$Length.2)
m25 = mean(dat$Ortho.2)
m26 = mean(dat$Phono.2)
m27 = mean(dat$Phonemes.2)
m28 = mean(dat$Syllables.2)
m29 = mean(dat$Morphemes.2)
m30 = mean(dat$AOA.2)
m31 = mean(dat$Valence.2)
m32 = mean(dat$Imageability.2)
m33 = mean(dat$Familiarity.2)
...
sd20 = sd(dat$TSS.2)
sd21 = sd(dat$QCON.2)
sd22= sd(dat$LogHAL.2)
sd23 = sd(dat$LogSub.2)
sd24 = sd(dat$Length.2)
sd25 = sd(dat$Ortho.2)
sd26 = sd(dat$Phono.2)
sd27 = sd(dat$Phonemes.2)
sd28 = sd(dat$Syllables.2)
sd29 = sd(dat$Morphemes.2)
sd30 = sd(dat$AOA.2)
sd31 = sd(dat$Valence.2)
sd32 = sd(dat$Imageability.2)
sd33 = sd(dat$Familiarity.2)

sd19;sd20;sd21;sd22;sd23;sd24;sd25;sd26;sd27;sd28;sd29;sd30;sd31;sd32;sd33

min19 = min(dat$QSS.2)
min20 = min(dat$TSS.2)
min21 = min(dat$QCON.2)
min22 = min(dat$LogHAL.2)
min23 = min(dat$LogSub.2)
min24 = min(dat$Length.2)
min25 = min(dat$Ortho.2)
min26 = min(dat$Phono.2)
min27 = min(dat$Phonemes.2)
min28 = min(dat$Syllables.2)
min29 = min(dat$Morphemes.2)
min30 = min(dat$AOA.2)
min31 = min(dat$Valence.2)
min32 = min(dat$Imageability.2)
min33 = min(dat$Familiarity.2)

min19;min20;min21;min22;min23;min24;min25;min26;min27;min28;min29;min30;min31;min32;min33

max19 = max(dat$QSS.2)
max20 = max(dat$TSS.2)
max21 = max(dat$QCON.2)
max22= max(dat$LogHAL.2)
max23 = max(dat$LogSub.2)
max24 = max(dat$Length.2)
max25 = max(dat$Ortho.2)
max26 = max(dat$Phono.2)
max27 = max(dat$Phonemes.2)
max28 = max(dat$Syllables.2)
max29 = max(dat$Morphemes.2)
max30 = max(dat$AOA.2)
max31 = max(dat$Valence.2)
max32 = max(dat$Imageability.2)
max33 = max(dat$Familiarity.2)
...
sd34 = sd(combined$QSS)
sd35 = sd(combined$TSS)
sd36 = sd(combined$QCON)
sd37 = sd(combined$LogHAL)
sd38 = sd(combined$LogSUB)
sd39 = sd(combined$Length)
sd40 = sd(combined$Ortho)
sd41 = sd(combined$Phono)
sd42 = sd(combined$Phonemes)
sd43 = sd(combined$Syllables)
sd44 = sd(combined$Morphemes)
sd45 = sd(combined$AOA)
sd46 = sd(combined$Valence)
sd47 = sd(combined$Imageability)
sd48 = sd(combined$Familiarity)

sd34;sd35;sd36;sd37;sd38;sd39;sd40;sd41;sd42;sd43;sd44;sd45;sd46;sd47;sd48

min34 = min(combined$QSS)
min35 = min(combined$TSS)
min36 = min(combined$QCON)
min37 = min(combined$LogHAL)
min38 = min(combined$LogSUB)
min39 = min(combined$Length)
min40 = min(combined$Ortho)
min41 = min(combined$Phono)
min42 = min(combined$Phonemes)
min43 = min(combined$Syllables)
min44 = min(combined$Morphemes)
min45 = min(combined$AOA)
min46 = min(combined$Valence)
min47 = min(combined$Imageability)
min48 = min(combined$Familiarity)

min34;min35;min36;min37;min38;min39;min40;min41;min42;min43;min44;min45;min46;min47;min48

max34 = max(combined$QSS)
max35 = max(combined$TSS)
max36 = max(combined$QCON)
max37 = max(combined$LogHAL)
max38 = max(combined$LogSUB)
max39 = max(combined$Length)
max40 = max(combined$Ortho)
max41 = max(combined$Phono)
max42 = max(combined$Phonemes)
max43 = max(combined$Syllables)
max44 = max(combined$Morphemes)
max45 = max(combined$AOA)
max46 = max(combined$Valence)
max47 = max(combined$Imageability)
max48 = max(combined$Familiarity)
...
tableprint1[2, ] = c("COS", "Maki, McKinley, & Thompson, 2004", m2, sd2, min2, max2)
...
tableprint2[4, ] = c("HAL Frequency", "Lund & Burgess, 1996", m7, sd7, min7, max7)
...
tableprint3[4, ] = c("HAL Frequency", "Lund & Burgess, 1996", m22, sd22, min22, max22)
...
tableprint4[4, ] = c("HAL Frequency", "Lund & Burgess, 1996", m37, sd37, min37, max37)
