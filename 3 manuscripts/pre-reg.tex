...
(\(\alpha\) = .05). However, because power is often underestimated
(Bakker, Hartgerink, Wicherts, \& Maas, 2016; Brysbaert \& Stevens,
2018), we plan to extend the analysis to include approximately 200
participants, a number determined by the amount of available funding.
Consistent with the design of the pilot study, participants will be
