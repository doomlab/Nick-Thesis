...
####setup####
dat2 = read.csv("stimuli jan 18.csv")
...
dat2 = dat[ , c(9:26, 45, 47)]
dat3 = dat[ ,c(27:44, 46, 48)]
...
tableprint2[2, ] = c("Concreteness", "Nelson et al., 2004", m6, sd6, min6, max6)
tableprint2[3, ] = c("HAL Frequency", "Lund and Burgess, 1996", m7, sd7, min7, max7)
tableprint2[4, ] = c("SUBTLEX Frequency", "Brysbaert and New, 2009", m8, sd8, min8, max8)
tableprint2[5, ] = c("Length", "Buchanan et al., 2013", m9, sd9, min9, max9)
tableprint2[6, ] = c("Ortho N", "Buchanan et al., 2013", m10, sd10, min10, max10)
tableprint2[7, ] = c("Phono N", "Buchanan et al., 2013", m11, sd11, min11, max11)
tableprint2[8, ] = c("Phonemes", "Buchanan et al., 2013", m12, sd12, min12, max12)
tableprint2[9, ] = c("Syllables", "Buchanan et al., 2013", m13, sd13, min13, max13)
tableprint2[10, ] = c("Morphemes", "Buchanan et al., 2013", m14, sd14, min14, max14)
tableprint2[11, ] = c("AOA", "Kuperman et al., 2012", m15, sd15, min15, max15)
tableprint2[12, ] = c("Valence", "Warriner et al., 2013", m16, sd16, min16, max16)
tableprint2[13, ] = c("Imageability", "Toglia and Battig, 1978", m17, sd17, min17, max17)
tableprint2[14, ] = c("Familiarity", "Toglia and Battig, 1978", m18, sd18, min18, max18)
tableprint2[15, ] = c("FSS", "Buchanan et al., 2013", m49, sd49, min49, max49)
tableprint2[16, ] = c("COSC", "Buchanan et al., 2013", m50, sd50, min50, max50)
...
tableprint3[1, ] = c("TSS", "Nelson et al., 2004", m20, sd20, min20, max20)
tableprint3[2, ] = c("Concreteness", "Nelson et al., 2004", m21, sd21, min21, max21)
tableprint3[3, ] = c("HAL Frequency", "Lund and Burgess, 1996", m22, sd22, min22, max22)
tableprint3[4, ] = c("SUBTLEX Frequency", "Brysbaert and New, 2009",m23, sd23, min23, max23)
tableprint3[5, ] = c("Length", "Buchanan et al., 2013", m24, sd24, min24, max24)
tableprint3[6, ] = c("Ortho N", "Buchanan et al., 2013", m25, sd25, min25, max25)
tableprint3[7, ] = c("Phono N", "Buchanan et al., 2013", m26, sd26, min26, max26)
tableprint3[8, ] = c("Phonemes", "Buchanan et al., 2013", m27, sd27, min27, max27)
tableprint3[9, ] = c("Syllables", "Buchanan et al., 2013", m28, sd28, min28, max28)
tableprint3[10, ] = c("Morphemes", "Buchanan et al., 2013", m29, sd29, min29, max29)
tableprint3[11, ] = c("AOA", "Kuperman et al., 2012", m30, sd30, min30, max30)
tableprint3[12, ] = c("Valence", "Warriner et al., 2013", m31, sd31, min31, max31)
tableprint3[13, ] = c("Imageability", "Toglia and Battig, 1978", m32, sd32, min32, max32)
tableprint3[14, ] = c("Familiarity", "Toglia and Battig, 1978", m33, sd33, min33, max33)
tableprint3[15, ] = c("FSS", "Buchanan et al., 2013", m51, sd51, min51, max51)
tableprint3[16, ] = c("COSC", "Buchanan et al., 2013", m52, sd52, min50, max52)
...
When examining the effects of single word norms, the dataset was combined with the dataset used collected in @Maxwell2018, which had been updated to contain information corresponding to each of the single word norms being investigated. 

SENTENCE JUSTIFYING THIS HERE, SOMETHING ABOUT LIMITATIONS. 

The combined dataset contained a total of 18,713 data points collected across 316 participants (after excluding participants in data screening). This dataset was used for the analyses investigating the effects of single word norms.

##Three-Way Interactions

First, a set of analyses was conducted to test whether interactions between database norms would replicate with the new stimuli set. These analyses followed the design of [@Maxwell2018].

SENTENCE HERE EXPLAINING MLM DESIGN

All database norms were mean centered.
...
```{r, include=FALSE}
####Judgment Simple Slopes Graph####
```


RECALL FINDINGS HERE
...
```{r, include=FALSE}
####recall simple slopes graph here####
```

THIS SECTION NEEDS TWO TABLES AND TWO SIMPLE SLOPES GRAPHS
