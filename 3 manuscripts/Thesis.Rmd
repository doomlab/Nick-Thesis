...
Single word norms were placed into one of three categories. Frequency (measured with SUBTLEX) and length were used as measures of lexical information (POS was ultimately excluded because the addition of this variable resulted in a singular matrix) Age of acquisition, valence, familiarity, concreteness, and imageability were classified as rated properties. Orthographic and phonographic neighborhoods, cue and target set sizes, feature set size, and cosine connectedness were grouped together as neighborhood connections.
